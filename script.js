...
const MENU = {
  "Пицца": {
    ...
    items: [
      { name: "Пицца Ассорти", price: "550 р.", emoji: "🍕", img: "images/мясная.jpg", desc: "Мясо, курица, колбаса, грибы." },
      { name: "Пицца Мясная", price: "550 р.", emoji: "🍕", img: "images/мясная.jpg", desc: "Мясо, сыр, помидор." },
      { name: "Пицца Куриная", price: "550 р.", emoji: "🍕", img: "images/куриная-пицца.jpg", desc: "Курица, сыр." },
      { name: "Пицца Куриная с грибами", price: "550 р.", emoji: "🍕", img: "images/куриная-с-грибами.jpg", desc: "Курица, грибы, сыр." },
      { name: "Пицца 4 сыра", price: "550 р.", emoji: "🧀", img: "images/4-сыра.jpg", desc: "Моцарелла, гауда, пармезан." },
      { name: "Пицца Пепперони", price: "550 р.", emoji: "🌶️", img: "images/пепперони.jpg", desc: "Колбаса, сыр." },
      { name: "Пицца Конструктор", price: "550 р.", emoji: "🍕", img: "images/конструктор.jpg", desc: "Две пиццы в одной — выберите две начинки." },
      { name: "Пицца Конструктор-Жульен", price: "600 р.", emoji: "🍕", img: "images/жульен-конструктор.jpeg", desc: "Две пиццы в одной — выберите две начинки." },
      { name: "Пицца Цезарь", price: "550 р.", emoji: "🥬", img: "images/пицца-цезарь.jpg", desc: "Салат, курица, сыр пармезан." },
      { name: "Пицца Сицилийская", price: "550 р.", emoji: "🌶️", img: "images/сицилийская.jpg", desc: "Курица, сыр, колбаса, оливки, острый перец." },
      { name: "Пицца Маргарита", price: "550 р.", emoji: "🍅", img: "images/маргарита.jpg", desc: "Помидор, сыр." },
      { name: "Пицца Грибная", price: "550 р.", emoji: "🍄", img: "images/грибная.jpg", desc: "Грибы, сыр." },
      { name: "Пицца Ойси", price: "800 р.", emoji: "🍣", img: "images/пицца-ойси.jpg", desc: "Креветка, лосось, икра, творожный сыр, унаги, спайси." },
      { name: "Пицца Конструктор с Ойси", price: "700 р.", emoji: "🍣", img: "images/конструктор-с-ойси.jpg", desc: "Креветка, лосось, икра, творожный сыр, унаги, спайси. (половина ойси, другая на выбор)" },
      { name: "Пицца Мексиканская", price: "550 р.", emoji: "🌮", img: "images/мексиканская.jpg", desc: "Острая пицца в мексиканском стиле." },
      { name: "Пицца Жульен", price: "650 р.", emoji: "🍄", img: "images/жульен.jpg", desc: "Курица, грибы, сливочный соус, сыр." },
      { name: "Пицца Барбекю", price: "550 р.", emoji: "🍖", img: "images/барбекю.jpg", desc: "Мясо, сыр, соус барбекю." }
    ]
  },
  "Сэты": {
    subtitle: "Наборы роллов на компанию",
    items: [
      { name: "Сэт 5 порций", price: "2000 р.", emoji: "🍱", img: "images/сэт-5-порций.jpg", desc: "2 Цезаря, Шик, Ойси, запечённый ролл." },
      { name: "Сэт 7 порций", price: "2400 р.", emoji: "🍱", img: "images/сэт-5-порций.jpg", desc: "2 Цезаря, 2 Шик, запечённый Цезарь, 2 Ойси." },
      { name: "Холодный сэт 5 порций", price: "2300 р.", emoji: "🍱", img: "images/холодный-сэт.jpg", desc: "Филадельфия, Ойси, Бакинский вечер, Бешеный лосось, Стамбульская ночь." },
      { name: "Гавайский сэт 9 порций", price: "3100 р.", emoji: "🍱", img: "images/гавайский-сэт.jpg", desc: "2 Шика, 2 Ойси, запечённый ролл, Стамбульская ночь, Бакинский вечер." },
      { name: "Горячий сэт 10 порций", price: "3500 р.", emoji: "🍱", img: "images/сет10.jpeg", desc: "2 Цезаря с курицей, 2 Цезаря с креветкой, Шик с курицей, Шик с лососем, Суши сендвич, Запеченные, 2 Ойси." }
    ]
  },
  "Горячие роллы": {
    ...
    items: [
      ...
      { name: "Цезарь запечёный", price: "400 р.", emoji: "🍣", img: "images/запеченный-ролл-курица.jpg", desc: "Классический запечённый цезарь-ролл с кунжутом и соусом." },
      ...
      { name: "Шик с курицей", price: "450 р.", emoji: "🍣", img: "images/шик-с-курицей.jpg", desc: "Запечённый ролл с курицей." },
  ...
  "Соусы": {
    subtitle: "Дополнительные соусы",
    items: [
      { name: "Соевый соус", price: "50 р.", emoji: "🥫", img: "images/соевый.jpg", desc: "Классический соевый соус." },
      { name: "Ореховый соус", price: "50 р.", emoji: "🥫", img: "images/ореховый.jpg", desc: "Ароматный ореховый соус." },
      { name: "Соус спайси", price: "50 р.", emoji: "🥫", img: "images/спайси.jpg", desc: "Острый соус спайси." },
      { name: "Томатный соус", price: "50 р.", emoji: "🥫", img: "images/томатный.jpg", desc: "Классический томатный соус." },
      { name: "Сырный соус", price: "50 р.", emoji: "🥫", img: "images/сырный-соус.jpg", desc: "Классический сырный соус." }
    ]
  },
  "Чай": {
    ...
    items: [
      ...
      { name: "Milka", price: "200 р.", emoji: "🍵", img: "images/milka.jpg", desc: "Травяной сбор для отдыха." },
    ]
  },
  "Горячие блюда": {
    subtitle: "Фурай",
