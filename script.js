...
const MENU = {
  ...
  "Сэты": {
    ...
    items: [
      { name: "Сэт 55 порций", price: "2000 р.", emoji: "🍱", img: "images/сэт-5-порций.jpg", desc: "2 Цезаря, Шик, Ойси, запечённый ролл." },
      ...
      { name: "Холодный сэт 10 порций", price: "3500 р.", emoji: "🍱", img: "images/гавайский-сэт.jpg", desc: "2 Цезаря с курицей, 2 Цезаря с креветкой, Шик с курицей, Шик с лососем, Суши сендвич, Запеченные, 2 Ойси." }
    ]
  },
  "Горячие роллы": {
