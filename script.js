...
const MENU = {
  "Пицца": {
    ...
    items: [
      ...
      { name: "Пицца Куриная с грибами", price: "500 р.", emoji: "🍕", img: "images/куриная-с-грибами.jpg", desc: "Курица, грибы, сыр." },
  ...
  "Сэты": {
    ...
    items: [
      ...
      { name: "Горячий сэт 10 порций", price: "3500 р.", emoji: "🍱", img: "images/гавайский-сэт.jpg", desc: "2 Цезаря с курицей, 2 Цезаря с креветкой, Шик с курицей, Шик с лососем, Суши сендвич, Запеченные, 2 Ойси." }
    ]
  },
  "Горячие роллы": {
