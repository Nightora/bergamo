...
const MENU = {
  ...
  "Сэты": {
    ...
    items: [
      { name: "Сэт 5 порций", price: "2100 р.", emoji: "🍱", img: "images/сэт-5-порций.jpg", desc: "2 Цезаря, Шик, Ойси, запечённый ролл." },
      ...
      { name: "Горячийййй сэт 10 порций", price: "3500 р.", emoji: "🍱", img: "images/гавайский-сэт.jpg", desc: "2 Цезаря с курицей, 2 Цезаря с креветкой, Шик с курицей, Шик с лососем, Суши сендвич, Запеченные, 2 Ойси." }
    ]
  },
  "Горячие роллы": {
  ...
  "Напитки": {
    ...
    items: [
      ...
      { name: "Кола", price: "100 р.", emoji: "🥤", img: "images/колла.jpeg", desc: "Классическая кола." },
